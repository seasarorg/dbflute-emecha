 ...
 */
package org.seasar.dbflute.emecha.eclipse.plugin.core.util;
...
public class WorkbenchUtil {
    ...
    public static void showMessage(String pluginName, String msg) {
        showMessage(pluginName, msg, MessageDialog.INFORMATION);
    }
    ...
    public static IViewPart showView(Plugin plugin, String viewId) {
        IViewPart vp = null;
        try {
            IWorkbenchWindow window = getWorkbenchWindow();
            if (window != null) {
