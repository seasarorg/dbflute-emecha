 ...
 *
 */
public class SQLServerSqlTemplateProcessor extends DefaultSqlTemplateProcessor {
    /**
     * {@inheritDoc}
    ...
    public String getSelectPagingSqlTemplate() {
        ...
        list.add("select *");
        list.add("  from (");
        list.add("plain.*, row_number() over(order by ...) as rn");
        list.add("  from (");
        list.add("select ...");
