 ...
 * @author schatten
 */
public class OpenCustomizeEntityAction extends AbstractOpenActionBase {
    /**
     *
     */
    public OpenCustomizeEntityAction() {
        super();
    }

    @Override
    protected String getTargetClassName(IFile file) {
        return getSqlName(file);
    }

    @Override
    protected String getTargetPackageName(String packageName) {
        return packageName + ".exentity.customize";
    }
}
