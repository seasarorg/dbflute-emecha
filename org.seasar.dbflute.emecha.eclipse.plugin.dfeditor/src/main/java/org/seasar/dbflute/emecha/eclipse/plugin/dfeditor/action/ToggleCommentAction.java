...
public class ToggleCommentAction extends TextEditorAction {
    ...
    public static class Factory {
        public ToggleCommentAction create(ResourceBundle bundle, String prefix, ITextEditor editor) {
            return new ToggleCommentAction(bundle, prefix, editor);
        }
    }
    ...
    // private static Logger log = Logger.getLogger(ToggleCommentAction.class);
